...
// provide reception timestamp
         ...
         /*
         PRINT_CSTSTR("\"dest\": %d, ", sx1272.packet_received.dst);
         PRINT_CSTSTR("\"type\": 0x%.2x, ", sx1272.packet_received.type);
         PRINT_CSTSTR("\"src\": %d, ", sx1272.packet_received.src);
         PRINT_CSTSTR("\"num\": %d, ", sx1272.packet_received.packnum);
         */
...
///////////////////////////////////////////////////////////////////
         ...
         for ( ; a<tmp_length; a++,b++) {
           char c = (char)sx1272.packet_received.data[a];
           if (isprint(c))
            PRINT_STR("%c", c);
